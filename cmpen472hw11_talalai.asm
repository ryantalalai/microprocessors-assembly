...
*                 and generate different waveforms. Analog digital conversion.
*
***********************************************************************
...
adc2        ldx     #msg5            ; print '> Set Terminal save file RxData3.txt'
            jsr     printmsg
            jsr     nextline
...
loopa       jsr    CountAndDisplay
            jsr     getchar
            cmpa    #0
            beq     loopa
            cmpa    #CR
            bne     loopa           ; if Enter/Return key is pressed, move the
...
numLoopadc
      			jsr    CountAndDisplay
      			ldx		ctr125u
      			cpx		#DATAmax		; check if 1024 numbers have been collected
      			bge		adcdone
